package br.com.keycloak.app_auth_youtube.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
       ...
       var result = rt.postForEntity("http://localhost:8080/realms/spring/protocol/openid-connect/token", entity, String.class);
